...
public class SimpleCylindrical implements Projection {
	...
	public SimpleCylindrical(int lines, int samples, Point2D ll, Point2D lr, Point2D ul, Point2D ur) {
		this.lines = lines;
...
//		if (a>b) return interpolate360(b, a, r);
	...
	public static void main(String args[]) {
		...
		SimpleCylindrical proj = new SimpleCylindrical(12127, 22528, ll, lr, ul, ur);

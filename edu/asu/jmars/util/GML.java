...
public class GML {
	...
	public static class Feature {
		...
		// single constructor
		public Feature( int t, GeneralPath p, String i, String d){
			type        = t;
			path        = p;
			id          = i;
			description = d;
		...
		public static int write( GML.Feature [] features, String file)
		{
			...
			try{
				...
				for (int i=0; i< features.length; i++){
					...
					GeneralPath     gp           = f.getGeneralPath();
					AffineTransform at           = new AffineTransform();
					PathIterator    pathIterator = gp.getPathIterator(at);
					switch (f.getType())
						{
						case GML.POINT: 
				...
				try {
					...
					try {
						...
						if (r!=null){
							...
							JOptionPane.showMessageDialog( null, "Error loading GML file: " + fileName + "\n");
						}
					} catch (Exception e){
						JOptionPane.showMessageDialog( null, "Error loading GML file: " + fileName + "\n");

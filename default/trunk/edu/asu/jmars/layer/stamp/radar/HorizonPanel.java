...
public class HorizonPanel extends JPanel{
	...
	public HorizonPanel(StampLView lview){
		myLView = lview;
	...
	private AbstractAction updateAct = new AbstractAction("Update Horizon") {
	...
	private AbstractAction delAct = new AbstractAction("Delete Selected") {
		public void actionPerformed(ActionEvent e) {
	...
	private AbstractAction csvAct = new AbstractAction("Export to CSV") {
		public void actionPerformed(ActionEvent e) {
	...
	private AbstractAction diffAct = new AbstractAction("Create Difference...") {
		public void actionPerformed(ActionEvent e) {
	...
	private AbstractAction diffDelAct = new AbstractAction("Delete Difference") {
		public void actionPerformed(ActionEvent e) {

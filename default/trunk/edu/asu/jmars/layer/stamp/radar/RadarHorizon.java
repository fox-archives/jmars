...
public class RadarHorizon implements Serializable{
	...
	public RadarHorizon(String radarID, ArrayList<Integer> xPoints, ArrayList<Integer> yPoints, ArrayList<Point2D> spatialPoints, int id, StampLayerSettings settings){
	 ...
	 */
	public GeneralPath getWorldPathForProj(MultiProjection proj){
		...
		for(Point2D pt : spatialPts){
			worldPts.add(proj.spatial.toWorld(pt));
		}
	...
	/**
	 *  There is a spatial point for each unique x pixel.

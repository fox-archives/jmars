...
//		add("Settings", settings);
	...
	Action reloadAction = new AbstractAction("Refresh Stats"){
		public void actionPerformed(ActionEvent e) {
...
//	}
	...
	private JPanel createEllipseNorthPanel(){
		...
		inpExpPanel.setBorder(BorderFactory.createTitledBorder("Import/Export Site Data"));
		...
		statsPanel.setBorder(new TitledBorder("Map Sampling Data"));

...
public class CraterFocusPanel extends FocusPanel {
	private final AtomicReference<CraterSettings> craterSettings = new AtomicReference<CraterSettings>();
	...
	public CraterFocusPanel(final LView parent) {
		...
		Action exportCsvAction = new AbstractAction("Export CSV") {
			public void actionPerformed(ActionEvent e) {
		...
		Action configAction = new AbstractAction("Config") {
			public void actionPerformed(ActionEvent e) {
		...
		Action exportDiamAction = new AbstractAction("Export Craterstats") {
			public void actionPerformed(ActionEvent e) {
...
//						System.out.println("NOT A VALID VALUE " + command);
		...
		Color beige = UIManager.getColor("Panel.background");
		Font font = new Font("Arial", Font.BOLD, 12);
		
	    JTextArea noteLabel = new JTextArea("Note: By default, each tick of the mousewheel is 10 increments.");
	    noteLabel.setEditable(false);
	    noteLabel.setWrapStyleWord(true);
	    noteLabel.setLineWrap(true);
	    noteLabel.setBackground(beige);
	    noteLabel.setForeground(Color.red);
	    noteLabel.setFont(font);
		noteLabel.setMaximumSize(new Dimension(0,50));
	    filterPanel.add(noteLabel);	
		...
		noteLabel4.setBackground(beige);
		noteLabel4.setFont(font);
		noteLabel4.setPreferredSize(new Dimension(0, 50));
		noteLabel4.setMaximumSize(new Dimension(300,50));
	    ...
	    noteLabel5.setBackground(beige);
		noteLabel5.setFont(font);
		noteLabel5.setPreferredSize(new Dimension(0, 50));
		noteLabel5.setMaximumSize(new Dimension(300,50));
	...
	private JPanel createDisplaySettingsPanel() {
		...
		SpringLayoutUtilities.makeCompactGrid(filterPanel, 3, 1, 6, 6, 6, 6); 
		panel.add(filterPanel);

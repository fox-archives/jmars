...
public class InterleavedTriangleStripArray extends TriangleStripArray
{
     ...
     *  @throws java.lang.IllegalArgumentException if vertexCount is less than 3 or the
     *        sum of all stripVertexCounts is not equal to vertexCount, or if the BY_REFERENCE
     *        and INTERLEAVED formats are not enabled
     */
    ...
    {
	calcNormalCCW( norm, vertexData,  v2, v1,  v1);
    }
    /**
    ...
    {
	double r = Math.sqrt(vertexData[v+NORMAL_OFFSET]*vertexData[v+NORMAL_OFFSET] + vertexData[v+NORMAL_OFFSET+1]*vertexData[v+NORMAL_OFFSET+1] + vertexData[v+NORMAL_OFFSET+2]*vertexData[v+NORMAL_OFFSET+2]);
